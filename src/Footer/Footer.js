...
const Footer = () => {
    return (
        <div className='relative'>
            <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded md:mt-24 mt-12 sticky bottom-0 left-0 right-0">
                ...
                <aside>
                    <p>Copyright © 2024 - All right reserved by Intellect X education Ltd</p>
                </aside>
            </footer>
        </div>
    );
